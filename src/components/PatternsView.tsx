  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 py-8 flex flex-col gap-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-[#e9dff2]">
        <div>
          <div className="flex items-center gap-2 text-[12px] font-semibold text-[#6200a9]">
            ...
            <span>•</span>
            <span className="text-[#4c4354]">Patterns Guide</span>
          </div>
      ...
      <div className="space-y-6">
        <div className="p-6 md:p-8 rounded-3xl bg-white border border-[#e9dff2] shadow-sm flex flex-col gap-3">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-[#f0dbff] flex items-center justify-center text-[#6200a9]">
              <span className="material-symbols-outlined text-[20px]">dataset</span>
            </div>
            <h2 className="text-[18px] font-bold text-[#1e1926]">
        ...
        <div className="p-6 md:p-8 rounded-3xl bg-white border border-[#e9dff2] shadow-sm flex flex-col gap-3">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-[#ebddff] flex items-center justify-center text-[#6e3aca]">
        ...
        <div className="p-6 md:p-8 rounded-3xl bg-white border border-[#e9dff2] shadow-sm flex flex-col gap-3">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-[#f0dbff] flex items-center justify-center text-[#7e22ce]">
