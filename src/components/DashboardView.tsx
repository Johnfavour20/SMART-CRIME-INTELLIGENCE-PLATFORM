...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  return (
    <div className="bg-[#fef7ff] font-sans text-[#1e1926] antialiased min-h-screen">
      ...
      <aside
        className={`fixed left-0 top-0 h-screen w-[260px] bg-white border-r border-[#e9dff2] z-50 flex flex-col justify-between transition-transform duration-300 ${
      ...
      >
        <div className="flex flex-col flex-1 min-h-0">
          ...
          <div className="h-16 px-5 flex items-center justify-between border-b border-[#e9dff2]">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  <span className="text-[10px] text-[#7e7385] px-1 py-0.2 rounded bg-[#f5eafd] font-medium">
                    v1.0 NBS
                  </span>
                </div>
              </div>
            ...
            <button
              className="lg:hidden p-1 text-[#7e7385] hover:text-[#1e1926]"
              onClick={() => setSidebarOpen(false)}
            >
              ✕
            </button>
          ...
          <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-1">
            <button
              type="button"
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left bg-[#f0dbff] text-[#6200a9] font-semibold relative before:content-[''] before:absolute before:left-0 before:top-2 before:bottom-2 before:w-1 before:bg-[#7e22ce] before:rounded-r cursor-pointer"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left text-[14px] text-[#4c4354] hover:bg-[#f5eafd] hover:text-[#1e1926] transition-colors cursor-pointer"
            >
            ...
            <div className="py-2">
              <div className="h-px bg-[#e9dff2] mx-3"></div>
            </div>
            ...
            <div className="pt-2">
              <button
                type="button"
                onClick={onBackToOverview}
                className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-left text-xs font-semibold text-[#7e22ce] bg-[#faf0ff] hover:bg-[#f0dbff] transition-colors cursor-pointer"
              >
        ...
        <div className="p-3 m-3 rounded-xl bg-[#faf0ff] border border-[#e9dff2] flex items-center gap-2">
          <span className="material-symbols-outlined text-[#6200a9] text-[16px]">verified</span>
          <span className="text-[11px] text-[#4c4354] font-medium truncate">
      ...
      <div className="lg:pl-[260px]">
        {/* Fixed Top Header */}
        <header className="fixed top-0 left-0 lg:left-[260px] right-0 h-16 bg-white/90 backdrop-blur-md border-b border-[#e9dff2] z-40 flex items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2">
            <button
              onClick={() => setSidebarOpen(true)}
              className="lg:hidden p-1.5 rounded-lg hover:bg-[#f5eafd] text-[#4c4354] cursor-pointer mr-1"
            >
              <span className="material-symbols-outlined text-[22px]">menu</span>
            </button>
            <span className="text-[13px] text-[#4c4354]">Smart Crime</span>
            <span className="material-symbols-outlined text-[#7e7385] text-[16px]">chevron_right</span>
            <span className="text-[15px] text-[#1e1926] font-semibold">Spatial Intelligence Console</span>
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#faf0ff] hover:bg-[#f5eafd] text-[#4c4354] border border-[#e9dff2] transition-colors cursor-pointer"
              type="button"
            >
              <span className="material-symbols-outlined text-[18px]">search</span>
              <span className="text-[13px]">Search incidents, LGAs, states...</span>
              <span className="text-[11px] bg-white px-1.5 py-0.5 rounded border border-[#cfc2d6] text-[#4c4354] ml-2 font-mono">
                ⌘K
              </span>
            </button>
            ...
            <button
              ...
              className="relative p-2 rounded-lg text-[#4c4354] hover:bg-[#faf0ff] transition-colors cursor-pointer"
              type="button"
            ...
            <div className="hidden md:flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#f5eafd] border border-[#e9dff2]">
              <span className="w-2 h-2 rounded-full bg-[#7e22ce] animate-pulse"></span>
              <span className="text-[11px] text-[#4c4354] font-medium">Encrypted Session (TLS 1.3)</span>
            </div>

            <div className="h-6 w-px bg-[#e9dff2] hidden sm:block"></div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="hidden sm:flex flex-col text-left">
                <span className="text-[12px] text-[#1e1926] font-semibold leading-tight">
                  {currentAnalyst || 'System User'}
                </span>
                <span className="text-[11px] text-[#7e7385] leading-tight">Authorized Analyst</span>
              </div>
            </div>
          </div>
        </header>
        ...
        <main className="w-full pt-20 bg-[#fef7ff] min-h-screen px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col w-full space-y-8 max-w-[1500px] mx-auto">
            {/* Top Context Header & Welcome Banner */}
            <section className="flex flex-col space-y-4">
              <div className="flex flex-col space-y-1">
                <div className="flex items-center gap-1.5 text-[#4c4354] text-[13px]">
                  <span
                    onClick={onBackToOverview}
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pt-1">
                  ...
                  <div className="flex items-center gap-2.5 shrink-0 self-start md:self-auto">
                    <button
                      onClick={() => onNavigateTab('data-visualizations')}
                      className="flex items-center gap-2 px-3.5 py-2 rounded-lg bg-[#f5eafd] hover:bg-[#efe4f8] text-[#4c4354] text-[13px] font-medium transition-all cursor-pointer"
                      type="button"
                    >
                ...
                {exportNotification && (
                  <div className="p-3 bg-[#FAF7FF] border border-[#E9DFF2] rounded-xl text-xs font-semibold text-[#7E22CE] flex items-center gap-2">
              ...
              {/* Welcome Card / Banner */}
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#efe4f8] via-[#f5eafd] to-[#faf0ff] p-6 lg:p-8">
                <div className="absolute -right-16 -top-16 w-64 h-64 rounded-full bg-[#6200a9]/5 blur-3xl pointer-events-none"></div>
                <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                  <div className="space-y-2 max-w-2xl">
                    <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-white text-[#6200a9] text-[11px] font-bold tracking-wide uppercase">
                  ...
                  <div className="flex items-center gap-4 shrink-0">
                    <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white border border-[#e9dff2]">
                      <span className="relative flex h-3 w-3">
                        <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                        <span className="relative inline-flex rounded-full h-3 w-3 bg-emerald-500"></span>
                      </span>
                      <div className="flex flex-col text-left">
                        <span className="text-[11px] font-bold tracking-wider text-[#1e1926] uppercase">
                          System Status
                        </span>
                        <span className="text-[13px] text-[#4c4354]">Operational (Historical Baseline)</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {/* KPI 1 */}
              <div className="group relative rounded-2xl bg-white p-6 border border-[#e9dff2] transition-all duration-300">
                <div className="flex items-start justify-between gap-3 mb-4">
                  <div className="flex flex-col">
                    <span className="text-[12px] text-[#4c4354] font-semibold uppercase tracking-wider">
                      Reported Cases
                    </span>
                    <span className="text-[32px] font-bold text-[#1e1926] tracking-tight mt-0.5">
                      134,663
                    </span>
                  </div>
                  <div className="w-12 h-12 rounded-xl bg-[#faf0ff] text-[#6200a9] flex items-center justify-center shrink-0 group-hover:bg-[#6200a9] group-hover:text-white transition-colors">
                    <span className="material-symbols-outlined text-[24px]">database</span>
                  </div>
                </div>
                <div className="flex items-center gap-2 text-[#4c4354]">
                  <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-[#f5eafd] text-[#6200a9] text-[11px] font-semibold">
                    Total Baseline
                  </span>
              ...
              <div className="group relative rounded-2xl bg-white p-6 border border-[#e9dff2] transition-all duration-300">
                <div className="flex items-start justify-between gap-3 mb-4">
                  ...
                  <div className="w-12 h-12 rounded-xl bg-[#ebddff] text-[#6e3aca] flex items-center justify-center shrink-0 group-hover:bg-[#6e3aca] group-hover:text-white transition-colors">
                    <span className="material-symbols-outlined text-[24px]">location_city</span>
                  </div>
                </div>
                <div className="flex items-center gap-2 text-[#4c4354]">
                  <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-[#f5eafd] text-[#6e3aca] text-[11px] font-semibold">
                    National
                  </span>
              ...
              <div className="group relative rounded-2xl bg-white p-6 border border-[#e9dff2] transition-all duration-300">
                <div className="flex items-start justify-between gap-3 mb-4">
                  ...
                  <div className="w-12 h-12 rounded-xl bg-[#f5eafd] text-[#7e22ce] flex items-center justify-center shrink-0 group-hover:bg-[#7e22ce] group-hover:text-white transition-colors">
                    <span className="material-symbols-outlined text-[24px]">category</span>
                  </div>
                </div>
                <div className="flex items-center gap-2 text-[#4c4354]">
                  <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-[#f5eafd] text-[#1e1926] text-[11px] font-semibold">
                    Hierarchy
                  </span>
              ...
              <div className="group relative rounded-2xl bg-white p-6 border border-[#e9dff2] transition-all duration-300">
                <div className="flex items-start justify-between gap-3 mb-4">
                  ...
                  <div className="w-12 h-12 rounded-xl bg-[#efe4f8] text-[#6200a9] flex items-center justify-center shrink-0 group-hover:bg-[#6200a9] group-hover:text-white transition-colors">
            ...
            <section className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-7 flex flex-col rounded-2xl bg-white p-6 border border-[#e9dff2] justify-between">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
                  <div>
                    <h3 className="text-[18px] font-bold text-[#1e1926]">Crime Trends Analysis</h3>
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#f5eafd] hover:bg-[#efe4f8] text-[#4c4354] text-[11px] font-semibold transition-colors cursor-pointer"
                    >
                      <span className="material-symbols-outlined text-[16px]">tune</span>
                      <span>{trendCategory === 'all' ? 'All Categories' : 'Property Focus'}</span>
                    </button>
                    <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#f0dbff] text-[#6200a9] text-[11px] font-bold">
                ...
                <div className="relative w-full h-[260px] flex items-center justify-center">
                  ...
                  <div className="absolute top-8 left-[64%] -translate-x-1/2 z-20 pointer-events-none flex flex-col items-center">
                    <div className="bg-[#342e3c] text-[#f7edff] px-3 py-1.5 rounded-lg text-center flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-[#f0dbff]"></span>
                ...
                {/* Trend Series Legend */}
                <div className="flex flex-wrap items-center justify-between gap-3 pt-4 border-t border-[#e9dff2]/60 mt-2">
                  <div className="flex items-center gap-2">
              ...
              <div className="lg:col-span-5 flex flex-col rounded-2xl bg-white p-6 border border-[#e9dff2] justify-between">
                <div>
                ...
                <div className="space-y-2 pt-4 border-t border-[#e9dff2]/60">
                  <div className="flex items-center justify-between p-2.5 rounded-lg bg-[#faf0ff]">
                    <div className="flex items-center gap-2">
                      <span className="w-3 h-3 rounded-full bg-[#7E22CE] shrink-0"></span>
                      <span className="text-[13px] font-medium text-[#1e1926]">Against Property</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-[14px] font-bold text-[#1e1926]">68,579</span>
                      <span className="text-[11px] px-1.5 py-0.5 rounded bg-[#f5eafd] font-semibold text-[#6200a9]">
                        50.9%
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-2.5 rounded-lg bg-[#faf0ff]">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[13px] font-medium text-[#1e1926]">Against Persons</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-[14px] font-bold text-[#1e1926]">53,641</span>
                      <span className="text-[11px] px-1.5 py-0.5 rounded bg-[#f5eafd] font-semibold text-[#6e3aca]">
                        39.8%
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-2.5 rounded-lg bg-[#faf0ff]">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[13px] font-medium text-[#1e1926]">Lawful Authority</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-[14px] font-bold text-[#1e1926]">12,443</span>
                      <span className="text-[11px] px-1.5 py-0.5 rounded bg-[#f5eafd] font-semibold text-[#7e7385]">
                        9.3%
                      </span>
                    </div>
                  </div>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-8 flex flex-col rounded-2xl bg-white p-6 border border-[#e9dff2] space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div>
                    <h3 className="text-[18px] font-bold text-[#1e1926]">Crime Distribution Across Nigeria</h3>
                    <p className="text-[13px] text-[#4c4354]">
                      Explore reported crime concentration by state (Sample historical spatial distribution)
                    </p>
                  </div>
                  <span className="px-3 py-1 rounded-full bg-[#f5eafd] text-[#4c4354] text-[11px] font-semibold self-start sm:self-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                  ...
                  <div className="md:col-span-7 relative flex items-center justify-center p-4 rounded-xl bg-[#faf0ff] overflow-hidden min-h-[320px]">
                    <svg
                    ...
                    >
                      ...
                      <path d="M 90 40 L 170 30 L 195 80 L 135 110 L 70 85 Z" fill="#E9DFF2" />
                      <path d="M 170 30 L 250 48 L 330 35 L 345 80 L 280 100 L 205 75 Z" fill="#FAF0FF" />
                    ...
                    <div className="absolute bottom-3 left-3 bg-white/90 backdrop-blur-sm p-2 rounded-lg border border-[#e9dff2] text-[11px] space-y-1">
                      <div className="flex items-center gap-1.5">
                        <span className="w-2.5 h-2.5 rounded bg-[#EDE9FE]"></span>
                        <span className="text-[#4c4354]">Lower density</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <span className="w-2.5 h-2.5 rounded bg-[#A855F7]"></span>
                        <span className="text-[#4c4354]">Moderate density</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <span className="w-2.5 h-2.5 rounded bg-[#6B21A8]"></span>
                        <span className="text-[#4c4354] font-semibold">Higher concentration</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-5 flex flex-col space-y-2">
                    <span className="text-[11px] text-[#7e7385] font-semibold uppercase tracking-wider">
                        ...
                        <div
                          ...
                          className={`flex items-center justify-between p-2 rounded-lg transition-colors cursor-pointer ${
                            selectedState === item.name
                              ? 'bg-[#f0dbff] border border-[#7e22ce]/30'
                              : 'bg-[#faf0ff] hover:bg-[#f5eafd]'
                          }`}
                        >
                          <div className="flex items-center gap-2">
                            <span
                              className={`w-5 h-5 rounded-full text-[11px] font-bold flex items-center justify-center ${
                                item.isTop
                                  ...
                                  : 'bg-[#efe4f8] text-[#1e1926]'
                              }`}
                            >
                              {item.rank}
                            </span>
                            <span className="text-[13px] font-semibold text-[#1e1926]">{item.state}</span>
                          </div>
                          <span
                            className={`text-[11px] ${
                              item.isTop ? 'text-[#6200a9] font-bold' : 'text-[#4c4354] font-medium'
                            }`}
                          >
                            {item.cases}
                          </span>
                    ...
                    <div className="p-2.5 rounded-lg bg-[#faf0ff] flex items-start gap-2 mt-2">
                      <span className="material-symbols-outlined text-[#7e7385] text-[16px] shrink-0 mt-0.5">
                        info
                      </span>
                      <p className="text-[11px] text-[#4c4354] leading-tight">
              ...
              <div className="lg:col-span-4 flex flex-col space-y-6">
                ...
                <div className="rounded-2xl bg-white p-6 border border-[#e9dff2] flex flex-col justify-between space-y-4">
                  <div className="space-y-1">
                    ...
                    <h4 className="text-[18px] font-bold text-[#1e1926]">Hotspot Analysis (K-Means)</h4>
                    <p className="text-[13px] text-[#4c4354]">
                  ...
                  <div className="pt-1">
                    <p className="text-[11px] text-[#7e7385] mb-3">
                      Unsupervised segmentation into 3 centroid envelopes.
                    </p>
                    <button
                      onClick={() => onNavigateTab('data-visualizations')}
                      className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-[#f5eafd] hover:bg-[#efe4f8] text-[#6200a9] text-[13px] font-semibold transition-all cursor-pointer"
                      type="button"
                    >
                ...
                <div className="rounded-2xl bg-white p-6 border border-[#e9dff2] flex flex-col justify-between space-y-4">
                  <div className="space-y-1">
                    ...
                    <h4 className="text-[18px] font-bold text-[#1e1926]">Prediction Intelligence</h4>
                    <p className="text-[13px] text-[#4c4354]">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="p-2.5 rounded-xl bg-[#faf0ff]">
                      <span className="text-[11px] text-[#7e7385] block">Decision Tree</span>
                      <span className="text-[15px] font-bold text-[#1e1926]">Ready</span>
                      <span className="text-[11px] text-emerald-700 font-semibold block mt-0.5">F1: 0.90</span>
                    </div>
                    <div className="p-2.5 rounded-xl bg-[#faf0ff]">
                      <span className="text-[11px] text-[#7e7385] block">Random Forest</span>
                      <span className="text-[15px] font-bold text-[#1e1926]">Ready</span>
                  ...
                  <div className="pt-1">
                    ...
                    <p className="text-[11px] text-[#7e7385] text-center mt-2 leading-tight">
            ...
            <section className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-[18px] font-bold text-[#1e1926]">Synthesized Intelligence Findings</h3>
                </div>
                <span className="text-[13px] text-[#4c4354]">Key empirical takeaways from NBS 2017 baseline</span>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Insight 01 */}
                <div className="flex flex-col justify-between rounded-2xl bg-white p-6 border border-[#e9dff2] transition-all">
                  <div className="space-y-2">
                    ...
                    <h4 className="text-[15px] font-bold text-[#1e1926]">Crime Distribution</h4>
                    <p className="text-[13.5px] text-[#4c4354] leading-relaxed">
                      Offences against property represent the single largest category in the current dataset, accounting for{' '}
                      <strong className="text-[#1e1926] font-semibold">50.9%</strong> of all reported cases nationally.
                    </p>
                  </div>
                  <button
                    onClick={() => onNavigateTab('data-visualizations')}
                    className="inline-flex items-center gap-1.5 text-[#6200a9] text-[13px] font-bold hover:text-[#2c0051] transition-colors mt-4 pt-3 border-t border-[#e9dff2]/50 text-left cursor-pointer"
                  >
                ...
                <div className="flex flex-col justify-between rounded-2xl bg-white p-6 border border-[#e9dff2] transition-all">
                  <div className="space-y-2">
                    ...
                    <h4 className="text-[15px] font-bold text-[#1e1926]">Geographic Pattern</h4>
                    <p className="text-[13.5px] text-[#4c4354] leading-relaxed">
                  ...
                  <button
                    onClick={() => onNavigateTab('data-visualizations')}
                    className="inline-flex items-center gap-1.5 text-[#6e3aca] text-[13px] font-bold hover:text-[#6200a9] transition-colors mt-4 pt-3 border-t border-[#e9dff2]/50 text-left cursor-pointer"
                  >
                ...
                <div className="flex flex-col justify-between rounded-2xl bg-white p-6 border border-[#e9dff2] transition-all">
                  <div className="space-y-2">
                    ...
                    <h4 className="text-[15px] font-bold text-[#1e1926]">Data Intelligence</h4>
                    <p className="text-[13.5px] text-[#4c4354] leading-relaxed">
                  ...
                  <button
                    onClick={() => onNavigateTab('patterns')}
                    className="inline-flex items-center gap-1.5 text-[#6100a8] text-[13px] font-bold hover:text-[#2c0051] transition-colors mt-4 pt-3 border-t border-[#e9dff2]/50 text-left cursor-pointer"
                  >
            ...
            <section className="space-y-2.5">
              <span className="text-[12px] text-[#7e7385] font-semibold uppercase tracking-wider">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <button
                  type="button"
                  onClick={() => onNavigateTab('data-visualizations')}
                  className="flex items-center gap-3 p-4 rounded-xl bg-white border border-[#e9dff2] hover:bg-[#faf0ff] transition-all group text-left cursor-pointer"
                >
                  <div className="w-11 h-11 rounded-lg bg-[#f5eafd] text-[#6200a9] flex items-center justify-center shrink-0 group-hover:bg-[#6200a9] group-hover:text-white transition-colors">
                    <span className="material-symbols-outlined text-[22px]">database</span>
                  </div>
                  <div className="flex flex-col min-w-0">
                    <span className="text-[15px] font-bold text-[#1e1926] truncate group-hover:text-[#6200a9] transition-colors">
                      Explore Crime Data
                    </span>
                    <span className="text-[12px] text-[#4c4354] truncate">Raw tables & filtering</span>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="flex flex-col min-w-0">
                    ...
                    <span className="text-[12px] text-[#4c4354] truncate">Time-series comparisons</span>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="flex flex-col min-w-0">
                    ...
                    <span className="text-[12px] text-[#4c4354] truncate">Interactive GIS viewports</span>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="flex flex-col min-w-0">
                    ...
                    <span className="text-[12px] text-[#4c4354] truncate">Apply trained classifiers</span>
                  </div>
                </button>
              </div>
            </section>
            ...
            <section className="rounded-2xl bg-white p-6 sm:p-8 border border-[#e9dff2]">
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-[#efe4f8] text-[#6200a9] flex items-center justify-center shrink-0">
                    <span className="material-symbols-outlined text-[22px]">verified_user</span>
                  </div>
                  <div>
                    <h4 className="text-[18px] font-bold text-[#1e1926]">Dataset Information</h4>
                    <p className="text-[13px] text-[#4c4354]">
                ...
                <button
                  onClick={() => onNavigateTab('patterns')}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#f5eafd] hover:bg-[#efe4f8] text-[#6200a9] text-[13px] font-semibold transition-colors shrink-0 cursor-pointer"
                  type="button"
                >
              ...
              {/* Metadata Grid */}
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 mt-6 pt-5 border-t border-[#e9dff2]/60">
                <div>
                  <span className="text-[11px] text-[#7e7385] uppercase tracking-wider block">Source</span>
                  <span className="text-[14px] font-bold text-[#1e1926]">National Bureau of Statistics (NBS)</span>
                </div>
                <div>
                  <span className="text-[11px] text-[#7e7385] uppercase tracking-wider block">Dataset</span>
                  <span className="text-[14px] font-bold text-[#1e1926]">Crime Statistics: Offences by State</span>
                </div>
                <div>
                  <span className="text-[11px] text-[#7e7385] uppercase tracking-wider block">Period</span>
                  <span className="text-[14px] font-bold text-[#1e1926]">2017 Historical Baseline</span>
                </div>
                <div>
                  <span className="text-[11px] text-[#7e7385] uppercase tracking-wider block">Total Reported</span>
                  <span className="text-[14px] font-bold text-[#1e1926]">134,663 Cases</span>
                </div>
                <div>
                  <span className="text-[11px] text-[#7e7385] uppercase tracking-wider block">Validation Level</span>
